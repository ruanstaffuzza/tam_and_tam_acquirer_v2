...
CREATE OR REPLACE TABLE `dataplatform-prd.master_contact.tam_acquirer_pre_previsao` PARTITION BY reference_date AS 
...
COALESCE(CAST(merchant_market_hierarchy_id as STRING), '') merchant_market_hierarchy_id mmhid_merge,
