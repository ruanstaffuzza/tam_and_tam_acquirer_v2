CREATE or REPLACE TABLE `dataplatform-prd.master_contact.aux_tam_pre_acquirer_v2` AS
--INSERT INTO Não pode pois a elimitação de duplicados é feita usando todos os períodos
...
count(distinct concat(
  REGEXP_REPLACE(REPLACE(nome_limpo,'IFOOD', ''), r'[^A-Z]', ''),
...
and not CONTAINS_SUBSTR(merchant_descriptor, "*")
...
SELECT
a.*,
CASE WHEN RIGHT(de42, 6) = '000000' then 'Stone'
    WHEN LENGTH(TRIM(de42)) = 9 THEN 'Rede'
